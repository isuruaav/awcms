    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-zinc-600">
                Create a page using safe HTML and Tailwind CSS utility classes.
            </p>
        </div>
        ...
        <section class="rounded-2xl border border-zinc-200 bg-white shadow-sm">
            <div class="border-b border-zinc-200 px-6 py-5">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-zinc-600">
                            Write HTML directly and use Tailwind CSS classes in the
                            <span class="font-mono">class</span> attribute.
                        </p>
                    </div>
            ...
            <div class="space-y-4 p-6">
                <textarea
                    ...
                    spellcheck="false"
                    wrap="off"
                    placeholder='<div class="mx-auto max-w-6xl px-6 py-12">&#10;    <h2 class="text-3xl font-bold text-zinc-950">About Us</h2>&#10;    <p class="mt-4 text-zinc-600">Your page content...</p>&#10;</div>'
                    class="min-h-[32rem] w-full resize-y rounded-xl border border-zinc-300 bg-zinc-950 px-4 py-4 font-mono text-sm leading-6 text-zinc-100 outline-none placeholder:text-zinc-500 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10"
                ></textarea>
                ...
                <div class="grid gap-3 lg:grid-cols-2">
                    <div class="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
                        ...
                        <p class="mt-1 text-sm leading-6 text-emerald-800">
                            Use normal HTML elements such as div, headings, paragraphs,
                            lists, links, images and tables. Tailwind utility classes are
                            preserved on allowed elements.
                        </p>
                    </div>
                    ...
                    <div class="rounded-xl border border-amber-200 bg-amber-50 p-4">
                        ...
                        <p class="mt-1 text-sm leading-6 text-amber-800">
                            Script, iframe, form, inline style and JavaScript event
                            attributes are removed automatically before storage.
                        </p>
                    </div>
                </div>
            </div>
