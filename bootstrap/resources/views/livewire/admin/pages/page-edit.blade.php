    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-zinc-600">
                Edit the page using safe HTML and Tailwind CSS utility classes.
            </p>
        </div>
        ...
        <section class="rounded-2xl border border-zinc-200 bg-white shadow-sm">
            ...
            <div class="space-y-4 p-6">
                <textarea
                    ...
                    spellcheck="false"
                    wrap="off"
                    class="min-h-[32rem] w-full resize-y rounded-xl border border-zinc-300 bg-zinc-950 px-4 py-4 font-mono text-sm leading-6 text-zinc-100 outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10"
                ></textarea>
                ...
                <div class="grid gap-3 lg:grid-cols-2">
                    <div class="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
                        ...
                        <p class="mt-1 text-sm leading-6 text-emerald-800">
                            Standard HTML elements and Tailwind classes are preserved.
                            Use the page body as your layout area.
                        </p>
                    </div>
                    ...
                    <div class="rounded-xl border border-amber-200 bg-amber-50 p-4">
                        ...
                        <p class="mt-1 text-sm leading-6 text-amber-800">
                            Scripts, iframes, forms, inline styles and JavaScript event
                            attributes are removed for security.
                        </p>
                    </div>
                </div>
            </div>
