<div class="space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-zinc-600">
                Create a new website page and save it as a draft.
            </p>
        </div>
    ...
    <form wire:submit="save" class="space-y-6">
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea id="page-excerpt" wire:model="excerpt" rows="3" maxlength="500"
                        placeholder="A short summary used in listings and search results."
                ...
                <div>
                    ...
                    <x-forms.rich-text-editor id="page-create-content" model="content" :value="$content"
                        label="Page content" />
        ...
        <section class="rounded-2xl border border-blue-200
                   bg-blue-50 p-5">
            ...
            <p class="mt-1 text-sm leading-6 text-blue-800">
                The new page will not be publicly visible. It will be
                saved with Draft status until it is submitted, approved
                and published.
            </p>
        </section>
