                    ...
                    @forelse ($logs as $log)
                        @php
                            $badgeClasses = match (true) {
                                str_starts_with($log->event, 'auth.login-failed') =>
                                    'bg-red-50 text-red-700',

                                str_starts_with($log->event, 'auth.') =>
                                    'bg-blue-50 text-blue-700',

                                str_contains($log->event, 'disabled'),
                                str_contains($log->event, 'password-reset') =>
                                    'bg-amber-50 text-amber-700',

                                str_contains($log->event, 'created'),
                                str_contains($log->event, 'activated') =>
        ...
        >
            ...
            <dl class="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div>
                    ...
                    <dd class="mt-1 text-sm text-zinc-800">
                        {{ $selectedLog->actor_name ?? 'Unauthenticated' }}
                    </dd>
                </div>
                ...
                <div>
                    ...
                    <dd class="mt-1 break-words text-sm text-zinc-800">
            ...
            <div class="mt-6 grid gap-5 lg:grid-cols-2">
                <div>
                    ...
                    <pre
                        class="mt-2 max-h-96 overflow-auto rounded-xl
                               bg-zinc-950 p-4 text-xs leading-6
                               text-zinc-100"
                    >{{ json_encode(
